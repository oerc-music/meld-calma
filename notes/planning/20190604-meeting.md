    ...
    /public
      ...
      /song_to_recording
        /song_annotation_xyz.ttl
          <> a oa:Annotation ;
            oa:motivation mc:SONG_TO_RECORDING ;
      ...
      /artist_name_to_id
        /artist_annotation_xyz.ttl
          <> a oa:Annotation ;
            oa:motivation mc:ARTIST_ID_NAME ;
...
And maybe later...
      ...
      /song_name_to_id
        /song_annotation_xyz.ttl
          <> a oa:Annotation
            oa:motivation mc:SONG_ID_NAME ;
            oa:target <...artists_songs/Mogwai_xyz/song_xyz.ttl...> or "song reference" (see below)
      ...
      /workset_feature_index
        /anno_workset_xyz
          <> a oa:Annotation
            ...
            oa:body   <workset_feature_container>
            .
...
The resulting annotations would have this general form:
    ...
    <> a oa:Annotation ;
      oa:motivation mc:KEY_DISTRIBUTION ;
      oa:target (recording reference in recording workset)
      oa:body (details @@TBD, based on key disribution data for recording obtained from CALMA)
      .
...
For all recordings, compute an "average" key distribution across all recordings of a given song (workset), and create a per-song annotation recording this.  Then for each recording, calculate a "key typicality" measure that represents deviation from average key distribution of that recording, and create a per-recording annotation for this.
    ...
    <> a oa:Annotation ;
      oa:motivation mc:SONG_KEY_PREVALANCE ;
      oa:target (song reference in song workset)
      oa:body 
        [ mc:key_info 
          [ mc:key_id (key id) ;
    ...
    <> a oa:Annotation ;
      oa:motivation mc:RECORDING_KEY_TYPICALITY ;
      oa:target (recording reference in recording workset)
      oa:body [ 
